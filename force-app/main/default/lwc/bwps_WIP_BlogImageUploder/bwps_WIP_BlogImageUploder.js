...
import BLOGIMAGE from '@salesforce/schema/Blog__c.BWPS_Blog_Image__c';
import ID_FIELD from '@salesforce/schema/Blog__c.Id';
import base64_field from '@salesforce/schema/Blog__c.BWPS_Image_Base64code__c';
const fieldsvalues = ['Blog__c.BWPS_Image_Base64code__c' , 'Blog__c.BWPS_Blog_Image__c' , 'Blog__c.Id'];
export default class Bwps_WIP_BlogImageUploder extends LightningElement {
    blogImage;
    @api recordId;
    @track blogRec;
    @track imageFile
