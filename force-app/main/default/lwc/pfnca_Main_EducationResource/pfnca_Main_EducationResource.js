...
export default class Pfnca_Main_EducationResource extends LightningElement {
img1 = `${imageResource}/WebsiteGeneralFiles/blog_photo.png`; img1 = `${imageResource}/WebsiteGeneralFiles/blog_photo.png`;
