...
import testimonialDonation from '@salesforce/apex/GetSliderSRecords.testimonialDonation';

export default class Bwps_donationpageslider extends LightningElement {
    ...
    @wire(testimonialDonation)
    testimonialDonationn({ error, data }) {
