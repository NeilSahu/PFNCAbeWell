...
export default class Bwps_WIP_TypesOfClasses extends LightningElement {
    ...
    fallbackImg = "data:image/svg+xml,%3Csvg id='Yoga' xmlns='http://www.w3.org/2000/svg' width='48' height='48' viewBox='0 0 48 48'%3E%3Crect id='Bounding_Box' data-name='Bounding Box' width='48' height='48' fill='none'/%3E%3Cg id='Group_8091' data-name='Group 8091' transform='translate(5 4)'%3E%3Cg id='Group_7158' data-name='Group 7158' transform='translate(0 0)'%3E%3Ccircle id='Ellipse_81' data-name='Ellipse 81' cx='5.201' cy='5.201' r='5.201' transform='translate(13.877 0)' fill='%23008ba7'/%3E%3Cpath id='Path_10971' data-name='Path 10971' d='M21.734,29.293h2.4a3.539,3.539,0,0,1,3.3,2l4.1,7.4c.3.5.6,1.2,1,1.8a12.223,12.223,0,0,0,3.2,3.6l2.6,1.9s2.1,1.6,1.4,3c-.8,1.5-3.1.8-6.3-1.1-4.6-2.8-7.8-11.1-7.8-11.1V50.3h-9.4v-13.5s-3.2,8.3-7.8,11.1c-3.2,1.8-5.5,2.5-6.3,1.1-.8-1.5,1.4-3,1.4-3l2.6-1.9a12.219,12.219,0,0,0,3.2-3.6c.4-.6.7-1.3,1-1.8l4.1-7.4a3.834,3.834,0,0,1,3.3-2h4Z' transform='translate(-1.957 -17.692)' fill='%23008ba7'/%3E%3Cpath id='Path_10972' data-name='Path 10972' d='M31.709,83.548a134.754,134.754,0,0,1-22-.5,3.008,3.008,0,0,0-3.3,2.6h0a3.013,3.013,0,0,0,2.7,3.3,141.539,141.539,0,0,0,29.1,0,3.013,3.013,0,0,0,2.7-3.3h0a3.008,3.008,0,0,0-3.3-2.6C35.61,83.248,33.709,83.448,31.709,83.548Z' transform='translate(-4.631 -50.144)' fill='%23008ba7'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E%0A";

    fallbackImgGenerator( text ){

        text = text.toLowerCase();

        if(text.includes('aerobic'))
            return this.img.Aerobic;
        else if(text.includes('boxing') || text.includes('box'))
            return this.img.Boxing;
        else if(text.includes('dance') || text.includes('dancing'))
            return this.img.Dance;
        else if(text.includes('exercise') || text.includes('fitness'))
            return this.img.Exercise;
        else if(text.includes('martial') || text.includes('social'))
            return this.img.MartialArts;
        else if(text.includes('speech') || text.includes('speak') || text.includes('communication'))
            return this.img.Speech;
    ...
    connectedCallback(){
        ...
        .then( result => {
            ...
            this.classTypeData =  this.classTypeData.map((ele) => {
                ...
                ele.logoimgLink = (ele.BWPS_Image_Base64code__c == '' || ele.BWPS_Image_Base64code__c == 'Sample Base64 Code' || ele.BWPS_Image_Base64code__c == undefined || ele.BWPS_Image_Base64code__c == null ) ? this.fallbackImgGenerator(ele.Name) :  `data:image/png;base64,${ele.BWPS_Image_Base64code__c}`  ;
